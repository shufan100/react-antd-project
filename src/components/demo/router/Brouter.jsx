...
export default class Brouter extends Component {
  ...
  pushShow = (id, title) => {
    // 1、编程式路由：params传参
    // this.props.history.push(`/home/brouter/detail/${id}/${title}`);

    // 2、编程式路由：search传参
    // this.props.history.push(`/home/brouter/detail?id=${id}&title22=${title}`);
  ...
  repalceShow = (id, title) => {
    // 1、编程式路由：params传参
    // this.props.history.replace(`/home/brouter/detail/${id}/${title}`);

    // 2、编程式路由：search传参
    // this.props.history.replace(`/home/brouter/detail?id=${id}&title22=${title}`);
